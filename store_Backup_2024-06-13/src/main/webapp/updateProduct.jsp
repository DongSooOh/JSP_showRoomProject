			...
			<div class="row align-items-md-stretch">
				...
				<div class="col-md-7">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-5">
							<input type="text" name="prodId" id="prodId" class="form-control" value='<%=rs.getString("prodId")%>'>
						</div>
					</div>
					<div class="mb-3 row">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-9">
							<textarea name="description" id="description" cols="50" rows="2" class="form-control" placeholder="100자 미만으로 작성하십시오."><%=rs.getString("description")%></textarea>
						</div>
					</div>
					<div class="mb-3 row">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-5">
							<input type="text" name="instock" id="instock" class="form-control" value='<%=rs.getString("instock")%>'> 
						</div>
					</div>
					<div class="mb-3 row">
